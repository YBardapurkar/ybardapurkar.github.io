				...
				<div className="section-inner shadow-sm rounded">
					...
					<div className="content">
						<div className="item">
							...
							<p>Work as full-stack developer on different domains such as Angular, Spring MVC, Android Development. Train and mentor new employees to get them started with their newly assigned tasks</p>
							<ul>
						...
						<div className="item">
							...
							<p>Internship as a part of the Practice School program of BITS Pilani University to provide students with an opportunity to work on industry projects, under the guidance of professional experts.</p>
							<ul>
